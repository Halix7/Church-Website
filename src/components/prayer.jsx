...
const prayer = () => {
  ...
  return (
    <div className='flex justify-center items-center flex-col'>
      ...
      <form className='flex justify-center items-center flex-col gap-3' onSubmit={prayerProceed}>
        ...
        <textarea className='border' name='message' rows={4} cols={50}  placeholder='Prayer Request*'/>
